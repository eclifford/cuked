...
Cucumber.prototype.run = function(callback) {
  ...
  args = process.argv.slice(2).concat(['-r', 'tests/acceptance/features', '-r', path.resolve(__dirname, 'cucumberjs/world.js'), '-r', path.resolve(__dirname, 'cucumberjs/hooks.js')]);
